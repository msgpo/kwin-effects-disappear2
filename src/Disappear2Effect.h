...
#ifndef EFFECTS_DISAPPEAR2_H
#define EFFECTS_DISAPPEAR2_H
...
class Disappear2Effect : public KWin::Effect {
public:
    Disappear2Effect();
...
inline int Disappear2Effect::requestedEffectChainPosition() const
{
    return 50;
}

#endif // EFFECTS_DISAPPEAR2_H
